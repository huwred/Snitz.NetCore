...
namespace MySqlMigrations.Migrations
{
    ...
    public partial class SeedData : SnitzMigration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            if(!migrationBuilder.IndexExists($"SELECT COUNT(MEMBER_ID) FROM {_memberTablePrefix}MEMBERS") || admin != null)
            {
                ...
                if(admin != null)
                {
                    migrationBuilder.InsertData(
                        ...
                        values: new object[] { 1, null, null, (short)0, null, null, null, installdate, 0, null, admin.Email, null, (short)0, null, null, null, null, null, null, null, null, (short)3, null, null, null, null, null, admin.UserName, null, null, null, 0, null, null, (short)0, null, (short)0, (short)0, null, null, (short)1, (short)0, null, (short)0, null });
                    ...
                    migrationBuilder.InsertData( // Admin User with password Passw0rd!
                        ...
                        values: new object[] { "8e445865-a24d-4543-a6c6-9443d048cdb9", 0, Guid.NewGuid().ToString(), "ForumUser", admin.Email, true, false, true, false, null, 1, null, admin.Email.ToUpperInvariant(), admin.UserName.ToUpperInvariant(), admin.Password, "+111111111111", true, null, 0, Guid.NewGuid().ToString(), false, null, admin.UserName });
                ...
                else
                {
                    migrationBuilder.InsertData(
                        table: $"{_memberTablePrefix}MEMBERS",
                        columns: new[] { "MEMBER_ID", "M_AGE", "M_AIM", "M_ALLOWEMAIL", "M_BIO", "M_CITY", "M_COUNTRY", "M_DATE", "M_DEFAULT_VIEW", "M_DOB", "M_EMAIL", "M_FIRSTNAME", "M_HIDE_EMAIL", "M_HOBBIES", "M_HOMEPAGE", "M_ICQ", "M_IP", "M_KEY", "M_LAST_IP", "M_LASTNAME", "M_LASTPOSTDATE", "M_LEVEL", "M_LINK1", "M_LINK2", "M_LNEWS", "M_MARSTATUS", "M_MSN", "M_NAME", "M_NEWEMAIL", "M_OCCUPATION", "M_PHOTO_URL", "M_POSTS", "M_PWKEY", "M_QUOTE", "M_RECEIVE_EMAIL", "M_SEX", "M_SHA256", "M_SIG_DEFAULT", "M_SIG", "M_STATE", "M_STATUS", "M_SUBSCRIPTION", "M_TITLE", "M_VIEW_SIG", "M_YAHOO" },
                        values: new object[] { 1, null, null, (short)0, null, null, null, installdate, 0, null, "xxxx@example.com", null, (short)0, null, null, null, null, null, null, null, null, (short)3, null, null, null, null, null, "Administrator", null, null, null, 0, null, null, (short)0, null, (short)0, (short)0, null, null, (short)1, (short)0, null, (short)0, null });

                    migrationBuilder.InsertData( // Admin User with password Passw0rd!
                        table: "AspNetUsers",
                        columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "IsActive", "IsAdmin", "LockoutEnabled", "LockoutEnd", "MemberId", "MemberSince", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "ProfileImageUrl", "Rating", "SecurityStamp", "TwoFactorEnabled", "UserDescription", "UserName" },
                        values: new object[] { "8e445865-a24d-4543-a6c6-9443d048cdb9", 0, Guid.NewGuid().ToString(), "ForumUser", "xxxx@example.com", true, false, true, false, null, 1, null, "XXXX@EXAMPLE.COM", "ADMINISTRATOR", "AQAAAAIAAYagAAAAEGhGQ8XcU+/GeShLZcARJtfYaIxYhK1lwlajwWCVmUJd1fOAdBhW0GhasV0QmAfCqw==", "+111111111111", true, null, 0, Guid.NewGuid().ToString(), false, null, "Administrator" });
            ...
            if(!migrationBuilder.IndexExists($"SELECT COUNT(CAT_ID) FROM {_forumTablePrefix}CATEGORY"))
            {
                migrationBuilder.InsertData(
            ...
            if(!migrationBuilder.IndexExists($"SELECT COUNT(N_ID) FROM {_forumTablePrefix}NAMEFILTER"))
            {
                migrationBuilder.InsertData(
            ...
            if(!migrationBuilder.IndexExists($"SELECT COUNT(COUNT_ID) FROM {_forumTablePrefix}TOTALS"))
            {
                migrationBuilder.InsertData(
