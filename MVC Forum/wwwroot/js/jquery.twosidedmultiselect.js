(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			var htmlBlock = "<div class=\"" + nameModifier + "options col-2 btn-group-vertical\">" +
			"<button type='button' rel=\"" + newName + "\" title=\"Add Selected\" class='AddOne btn btn-secondary'><i class='fa fa-angle-right'></i></button>" +
			"<button type='button' rel=\"" + newName + "\" title=\"Add All\" class='AddAll btn btn-secondary'><i class='fa fa-angle-double-right'></i></button>" +
			"<button type='button' rel=\"" + newName + "\" title=\"Remove Selected\" class='RemoveOne btn btn-secondary'><i class='fa fa-angle-left'></i></button>" +
			"<button type='button' rel=\"" + newName + "\" title=\"Remove All\" class='RemoveAll btn btn-secondary'><i class='fa fa-angle-double-left'></i></button>" +
			"</div>" +
			"<div class=\"" + nameModifier + "select col-5\">" +
			...
			$This.wrap("<div class=\"" + nameModifier + "select col-5\" />");
