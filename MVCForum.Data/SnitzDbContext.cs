...
namespace SnitzCore.Data
{
    public class SnitzDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new(){Id = "2c5e174e-3b0e-446f-86af-483d56fd7210", Name = "Admin", NormalizedName = "Admin".ToUpper() }, 
            ...
            modelBuilder.Entity<MemberNamefilter>().HasData(new MemberNamefilter { Id = 1, Name = "Admin" });
            modelBuilder.Entity<Post>();
            modelBuilder.Entity<PostReply>();
            modelBuilder.Entity<MemberSubscription>();
            //modelBuilder.Entity<ForumTotal>().HasData(new ForumTotal { Id = 1, ArchivedPostCount = 0, ArchivedTopicCount = 0, PostCount = 1, TopicCount = 1, UserCount = 0 });
            ...
            modelBuilder.Entity<SnitzConfig>().HasData(new List<SnitzConfig>()
            {
            ...
            //modelBuilder.Entity<MemberRanking>().HasData(new List<MemberRanking>()
            //{
            //    new (){Id=1,Image="gold",ImgRepeat= 5,Posts=0,Title="Administrator"},
            //    new (){Id=2,Image="silver",ImgRepeat= 5,Posts=0,Title="Moderator"},
            //    new (){Id=3,Image="bronze",ImgRepeat= 0,Posts=0,Title="Starting Member"},
            //    new (){Id=4,Image="green",ImgRepeat= 1,Posts=5,Title="Newbie"},
            //    new (){Id=5,Image="cyan",ImgRepeat= 2,Posts=50,Title="Junior"},
            //    new (){Id=6,Image="blue",ImgRepeat= 3,Posts=250,Title="Average Member"},
            //    new (){Id=7,Image="purple",ImgRepeat= 4,Posts=500,Title="Knowitall"},
            //    new (){Id=8,Image="bronze",ImgRepeat= 5,Posts=2000,Title="Forum Guru"}
