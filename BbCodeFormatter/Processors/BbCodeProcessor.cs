...
public class BbCodeProcessor : ICodeProcessor
  {
    ...
    _tables.Add(new RegexFormatter(@"(\[\/table])", "</table>"));
    _tables.Add(new RegexFormatter(@"(\[(tr)([^]]*)])", "<tr class=\"divTableRow\" $3>"));
    _tables.Add(new RegexFormatter(@"(\[(td)([^]]*)])", "<td class=\"divTableCell\" $3>"));
    _tables.Add(new RegexFormatter(@"(\[(th)([^]]*)])", "<th class=\"divTableHead\" $3>"));
    _tables.Add(new RegexFormatter(@"(\[\/t([rdh])](\r\n|\r|\n)*)", "</t$2>"));
    _tables.Add(new RegexFormatter(@"(\[tbody([^]]*)])", "<div class=\"divTableBody\" $2>"));
    _tables.Add(new RegexFormatter(@"(\[\/tbody])", "</tbody>"));
    _tables.Add(new RegexFormatter(@"(\[thead([^]]*)])", "<div class=\"divTableHeader\" $2>"));
    _tables.Add(new RegexFormatter(@"(\[\/thead])", "</thrad>"));
    _tables.Add(new RegexFormatter(@"(\[tfoot([^]]*)])", "<div class=\"divTableFooter\" $2>"));
